...
public class Modeltaijutsu_chestplate<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "taijutsu_chestplate"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition jonin_chestplate = partdefinition.addOrReplaceChild("jonin_chestplate",
				CubeListBuilder.create().texOffs(38, 13)
						.addBox(2.0F, 0.0F, -3.05F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(44, 25)
						.addBox(-5.0F, 0.0F, -3.05F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(30, 44)
						...
						.addBox(-5.0F, 0.0F, -3.0F, 1.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(38, 42)
						.addBox(-5.0F, -2.0F, -2.0F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 13)
		...
		PartDefinition jonin_right_arm = partdefinition.addOrReplaceChild("jonin_right_arm",
				CubeListBuilder.create().texOffs(30, 31)
						.addBox(-3.0F, -2.0F, -3.0F, 3.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 16)
						.addBox(-3.0F, -2.0F, 2.0F, 3.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 0)
						.addBox(-4.0F, -2.0F, -2.0F, 1.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 20)
		...
		PartDefinition jonin_left_arm = partdefinition.addOrReplaceChild("jonin_left_arm",
				CubeListBuilder.create().texOffs(38, 0)
						.addBox(0.0F, -2.0F, -3.0F, 3.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 29)
						.addBox(0.0F, -2.0F, 2.0F, 3.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
						.addBox(3.0F, -2.0F, -2.0F, 1.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(10, 31)
						.addBox(-1.0F, -2.0F, -2.0F, 1.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 0)
