...
public class CharattributeexplimitsetcommandProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (!world.isClientSide() && world.getServer() != null)
			world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("Chacter Limit Experience has been set. New Value = " + new java.text.DecimalFormat("##.##")
