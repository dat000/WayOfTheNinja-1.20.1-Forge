...
public class ChangebodytypeProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if ((entity.getCapability(WayOfTheNinjaForge1201ModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WayOfTheNinjaForge1201ModVariables.PlayerVariables())).character_body_type == 0) {
			if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
				...
				if (ResourceLocation.tryParse("way_of_the_ninja_forge_1_20_1:textures/entities/body_type_0.png") != null) {
					_texture = new ResourceLocation("way_of_the_ninja_forge_1_20_1:textures/entities/body_type_0.png");
				}
			...
			if (!world.isClientSide() && world.getServer() != null)
				world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("body type is 0"), false);
		} else if ((entity.getCapability(WayOfTheNinjaForge1201ModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new WayOfTheNinjaForge1201ModVariables.PlayerVariables())).character_body_type == 1) {
			if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
				ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
				if (ResourceLocation.tryParse("way_of_the_ninja_forge_1_20_1:textures/entities/body_type_1.png") != null) {
					_texture = new ResourceLocation("way_of_the_ninja_forge_1_20_1:textures/entities/body_type_1.png");
				}
				new com.kleiders.kleidersplayerrenderer.KleidersSkinRenderer(context, true, _texture).render((AbstractClientPlayer) _evt.getEntity(), _evt.getEntity().getYRot(), _evt.getPartialTick(), _evt.getPoseStack(), _evt.getMultiBufferSource(),
						_evt.getPackedLight());
			}
			if (!world.isClientSide() && world.getServer() != null)
				world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("body type is 1"), false);
		}
	}
}
