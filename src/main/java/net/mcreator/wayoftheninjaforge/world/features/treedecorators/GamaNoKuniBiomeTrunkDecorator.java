...
public class GamaNoKuniBiomeTrunkDecorator extends TrunkVineDecorator {
	public static Codec<GamaNoKuniBiomeTrunkDecorator> CODEC = Codec.unit(GamaNoKuniBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("gama_no_kuni_biome_tree_trunk_decorator", DECORATOR_TYPE));
	}
