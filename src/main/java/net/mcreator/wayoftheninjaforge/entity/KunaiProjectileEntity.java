...
import net.mcreator.wayoftheninjaforge.procedures.DropKunaiStandartProcedure;
...
public class KunaiProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(WayOfTheNinjaForge1201ModItems.KUNAI_STANDARTITEM.get());

	public KunaiProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(WayOfTheNinjaForge1201ModEntities.KUNAI_PROJECTILE.get(), world);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		DropKunaiStandartProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static KunaiProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		KunaiProjectileEntity entityarrow = new KunaiProjectileEntity(WayOfTheNinjaForge1201ModEntities.KUNAI_PROJECTILE.get(), entity, world);
	...
	public static KunaiProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		KunaiProjectileEntity entityarrow = new KunaiProjectileEntity(WayOfTheNinjaForge1201ModEntities.KUNAI_PROJECTILE.get(), entity, entity.level());
