...
public class DeidaraEntity extends Monster {
	public DeidaraEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WayOfTheNinjaForge1201ModEntities.DEIDARA.get(), world);
	}

	public DeidaraEntity(EntityType<DeidaraEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Deidara"));
