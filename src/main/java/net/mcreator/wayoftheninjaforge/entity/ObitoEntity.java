...
public class ObitoEntity extends Monster {
	public ObitoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WayOfTheNinjaForge1201ModEntities.OBITO.get(), world);
	}

	public ObitoEntity(EntityType<ObitoEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Obito"));
