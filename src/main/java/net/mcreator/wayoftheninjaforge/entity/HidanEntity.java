...
public class HidanEntity extends Monster {
	public HidanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WayOfTheNinjaForge1201ModEntities.HIDAN.get(), world);
	}

	public HidanEntity(EntityType<HidanEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Hidan"));
