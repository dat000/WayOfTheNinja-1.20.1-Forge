...
public class PainEntity extends Monster {
	public PainEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WayOfTheNinjaForge1201ModEntities.PAIN.get(), world);
	}

	public PainEntity(EntityType<PainEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Pain"));
