...
public class GuiButtonMessage {
	...
	public GuiButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(GuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		WayOfTheNinjaForge1201Mod.addNetworkMessage(GuiButtonMessage.class, GuiButtonMessage::buffer, GuiButtonMessage::new, GuiButtonMessage::handler);
	}
}
